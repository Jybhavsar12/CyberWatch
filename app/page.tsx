...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black transition-colors">
      {/* Header */}
      <header className="border-b border-black/10 dark:border-white/10 bg-white dark:bg-black sticky top-0 z-50 backdrop-blur-sm bg-white/80 dark:bg-black/80">
              ...
              {user ? (
                <>
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="border-black/20 dark:border-white/20 hover:bg-black/5 dark:hover:bg-white/5"
                  >
                    SIGN OUT
                  </Button>
                </>
                ...
                <>
                  <Link href="/login">
                    <Button variant="outline" className="border-black/20 dark:border-white/20 hover:bg-black/5 dark:hover:bg-white/5">
                      LOGIN
                    </Button>
                  </Link>
                  <Link href="/subscribe">
                    <Button className="bg-black dark:bg-white text-white dark:text-black hover:bg-black/90 dark:hover:bg-white/90 font-medium tracking-wide">
                      SUBSCRIBE
                    </Button>
                  </Link>
                </>
