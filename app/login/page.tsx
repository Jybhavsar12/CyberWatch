      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-black/10 dark:border-white/10 bg-white dark:bg-black">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold tracking-tight text-black dark:text-white">Welcome Back</CardTitle>
          ...
          <CardContent>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white dark:bg-black px-2 text-black/40 dark:text-white/40 tracking-wider">Or continue with</span>
              </div>
            </div>
            ...
            <Button
              ...
              className="w-full border-black/20 dark:border-white/20 hover:bg-black/5 dark:hover:bg-white/5"
            >
